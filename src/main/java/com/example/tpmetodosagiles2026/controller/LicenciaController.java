...
public class LicenciaController {
    ...
    public ResponseEntity<?> emitir(@RequestBody EmitirLicenciaDTO dto) {
        LOGGER.info("Recibida solicitud de emisión: titular='{}', documento='{}', clase='{}', fechaNacimiento='{}', vigencia='{}'",
                dto.getTitular(), dto.getNumeroDocumento(), dto.getClase(), dto.getFechaNacimiento(), dto.getVigencia());
        try {
